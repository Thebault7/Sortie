 ...
 */
final class Version20200211072127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD site_id INT DEFAULT NULL, ADD pseudo VARCHAR(50) NOT NULL, ADD password VARCHAR(150) NOT NULL');
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD lieu_id INT DEFAULT NULL, ADD site_id INT NOT NULL, ADD participant_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP site_id, DROP pseudo, DROP password');
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP lieu_id, DROP site_id, DROP participant_id');
    }
}
