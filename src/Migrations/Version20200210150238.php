 ...
 */
final class Version20200210150238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD site_id INT DEFAULT NULL, ADD pseudo VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP site_id, DROP pseudo');
